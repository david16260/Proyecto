         ...
         switch(opcion){
              ...
              case 1://Agregar Registro
                if (vehDAO.agregarRegistro()) {
                    request.setAttribute("mensajeExito", "El vehículo se registró corectamente");
                } else {
                    request.setAttribute("mensajeError", "El vehículo no se registró corectamente");
                }
                request.getRequestDispatcher("registrarVehiculo.jsp").forward(request, response);
                break;
            case 2://Actualizar Registro
                if (vehDAO.actualizarRegistro()) {
                    request.setAttribute("mensajeExito", "El vehículo se actualizo corectamente");
                } else {
                    request.setAttribute("mensajeError", "El vehículo no se actualizo corectamente");
                }
            ...
            case 3:
                ...
                if (vehVO !=null) {
                    ...
                    request.setAttribute("mensajeExito", "El vehículo no existe");
